...
/* 
let aprobados = estudiantesFunval.filter(estudiantes => estudiantesFunval > 76);
console.log(aprobados.toUpperCase()) */

let aprobados = estudiantesFunval.filter(estudiante => estudiante.nota > 76)
